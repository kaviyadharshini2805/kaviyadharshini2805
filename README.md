...
A web application that combines information from multiple candidate data sources into a single record. The project includes conflict resolution, confidence scoring, data provenance, and visual summaries to improve data consistency.

**Tech Stack:** Python, FastAPI, Streamlit, Pandas, Pydantic
